...
A Bun + Next.js full-stack management application for AgentCortex. The backend API and frontend are served from the same Next.js process on the same port. There is no separate API server.
